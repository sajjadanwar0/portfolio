...
const projects = [
    {
        name: 'Workreel',
        description:
            'WorkReel is a video-driven, career marketplace that matches businesses with talent.',
        link: {href: 'https://workreel.com', label: 'workreel.com'},
        logo: workreel,
    },
    {
        name: 'Siguto',
        description:
            'A social media platform connecting fans and celebrities through personalised digital autographs and memorabilia at events.',
        link: {href: 'https://siguto.com', label: 'siguto.com'},
        logo: siguto,
    },
    {
        name: 'Snareobics',
        description:
            'Music learning app.',
        link: {href: 'https://snareobics.com', label: 'snareobics.com'},
        logo: snareobics,
    },
    {
...
export default function Projects() {
    return (
        <>
            <Head>
                <title>Projects - Sajjad Anwar</title>
                <meta
                    name="description"
            ...
            <SimpleLayout
                ...
                intro="I’ve worked on tons of little projects over the years but these are the ones that I’m most proud of. Many of them are closed sources, commercial ones, so if you see something that piques your interest, contact  or give feedback."
            >
                <ul
                    role="list"
