...
class Authorization
{
     ...
     * @var bool
     */
    public static bool $registersInGate = true;
     ...
     */
    public static ?DateTimeInterface $cacheExpiresAt;
     ...
     * @var bool
     */
    public static bool $cachesPermissions = true;
     ...
     * @var string
     */
    public static string $cacheKey = 'authorization.permissions';
     ...
     * @var string
     */
    public static string $roleModel = 'App\Models\Role';
     ...
     * @var string
     */
    public static string $permissionModel = 'App\Models\Permission';
     ...
     * @return static
     */
    public function disableGateRegistration(): Authorization
    {
     ...
     * @return static
     */
    public static function disablePermissionCache(): Authorization
    {
